...
public class Level_3 {
    ...
    final public String ref = "Level_3";
    private Level_3 my_level;
    ...
    public Level_3(String username, String no_received, String color) {
    ...
    public void increment_no_received() {
        ...
        myRef.runTransaction(new Transaction.Handler() {
            ...
            public Transaction.Result doTransaction(MutableData mutableData) {
                my_level = mutableData.getValue(Level_3.class);
                if (my_level == null) {
